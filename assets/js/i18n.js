...
(function(){
  const DICT = {
    ...
    o_snappy:{en:'🛈 <b style="color:var(--gold-soft)">Pickup</b> orders are placed here. For <b style="color:var(--gold-soft)">delivery</b>, we\'ll take you to Uber Eats.',fr:"🛈 Les commandes <b style=\"color:var(--gold-soft)\">à emporter</b> se font ici. Pour la <b style=\"color:var(--gold-soft)\">livraison</b>, nous vous dirigeons vers Uber Eats."},
    ...
    o_ph_name:{en:"Your name",fr:"Votre nom"}, o_ph_phone:{en:"Phone number",fr:"Numéro de téléphone"},
    o_place:{en:"Place pickup order",fr:"Passer la commande"},
    o_note:{en:"Your order is sent straight to the kitchen for pickup at 4771 Sources Blvd. No online payment — pay when you pick up.",fr:"Votre commande est envoyée directement en cuisine pour ramassage au 4771 boul. des Sources. Aucun paiement en ligne — payez au ramassage."},
    o_ok_title:{en:"Order received!",fr:"Commande reçue !"},
    o_ok_msg:{en:"We'll have it ready for pickup in about 15–25 minutes at 4771 Sources Blvd, Pierrefonds. We'll call you if we need anything.",fr:"Elle sera prête pour le ramassage dans environ 15–25 minutes au 4771 boul. des Sources, Pierrefonds. Nous vous appellerons au besoin."},
    o_ok_sms:{en:"We also opened a text so you can send it to us directly.",fr:"Nous avons aussi ouvert un texto que vous pouvez nous envoyer directement."},
    o_ok_done:{en:"Done",fr:"Terminé"},
